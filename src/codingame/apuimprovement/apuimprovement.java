...
class Player
{
	...
	public static void main(String args[]) throws FileNotFoundException
	{
		...
		//		in = new Scanner(new File("R:\\Dropbox\\Programmieren\\einsnull\\src\\apuimprovement\\ms2"));
	...
	private static boolean addBridgesToConn(int b, Conn c, Set<Conn> allConns, List<String> out)
	{
		...
		if (c.bridges == b)
		{ //before was 0 = entirely new bridge created which may block other connections
